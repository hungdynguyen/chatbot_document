...
class RetryingChatDeepSeek(ChatOpenAI):
    def __init__(self, api_key, model="deepseek-chat", temperature=0.0, max_retries=2, request_timeout=180):
        super().__init__(
            model=model,
            api_key=api_key,
...
class RagasEvaluator:
    def __init__(self, list_of_api_keys: list):
        ...
        #     request_timeout = 180
        # )
        llm_instance = RetryingChatDeepSeek(
            api_key="sk-434edbafbf604a96849043af835fd563",
            model="deepseek-chat",
            temperature=0.0,
            max_retries=2,
            request_timeout=180
